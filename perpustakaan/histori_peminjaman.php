...
include "header.php";
?>
<center><h2>Histori Peminjaman Buku</h2></center>
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
		   ...
		   //menampilkan buku yang dipinjam
            ...
            if(mysqli_num_rows($qry_cek_kembali)>0){
                ...
                $button_kembali="<a href='kembali.php?id=".$dt_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"kembalikan?\")'>Kembalikan</a>";
            }
        ?>
            <tr>
                <td><?=$no?></td>
