...
<?php
    ...
    ?>
    <br>
    <a href="tambah_siswa.php"> <input type="submit" name="simpan" value="Tambah Siswa" class="btn btn-success" style="margin-left: 10px;"></a>
    <center><h3>Tampil Siswa</h3></center>
